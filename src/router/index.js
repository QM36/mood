...
export const asyncRouterMap = [

 {
    ...
    children: [
     ...
     {path: '/home', name: 'Home', icon:'speedometer', component: _import('Home/index')},
     {path: '/detail/:id', name: 'Detail', icon:'speedometer', component: _import('Detail/index')},
     {path: '/physiology/:id', name: 'Physilogy', icon:'speedometer', component: _import('Physiology/index')},
     {path: '/mood/:id', name: 'Mood', icon:'speedometer', component: _import('Mood/index')},
     {path: '/location/:id', name: 'Location', icon:'speedometer', component: _import('Location/index')},
     {path: '/abnormal/:id', name: 'Abnormal', icon:'speedometer', component: _import('Abnormal/index')},
